  ...
  >
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3 mb-6 md:mb-0">
        ...
        <div v-if="!datos.solucionado && datos.is_respondido" class="px-3 w-full flex flex-col mb-6 md:mb-0">
          <label
            class="block uppercase tracking-wide text-white text-xs font-bold mb-2"
    ...
    <div v-if="!datos.solucionado">
      <div v-if="datos.is_respondido === true">
        <button
...
export default {
  ...
  setup(props) {
    ...
    return { datos, answerTicket, answer }
  }
};
