<template>
    <div>
      <div id="HeaderInfo" class="relative flex flex-col-reverse py-16 lg:py-0 lg:flex-col">
        <div class="w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl">
          ...
          <h2 class="mb-5 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none md:text-center">
          !La mejor página para hosting <br class="hidden md:block" />
          únete ya y aplica a nuestros servicios! 
          </h2>
          <p class="mb-5 text-base text-white md:text-lg md:text-center">
        ...
        <div class="flex flex-col items-center">
          <div class="mb-2 text-sm text-white md:mb-2">Follow us</div>
            ...
            <div class="flex items-center">
              <a href="/" class="text-white transition-colors duration-300 hover:text-red-accent-50">
            ...
            <div class="flex items-center">
              <a href="/" class="text-white transition-colors duration-300 hover:text-red-accent-400">
                <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
                  <path
            ...
            <div class="flex items-center">
              <a href="/" class="text-white transition-colors duration-300 hover:text-deep-purple-accent-100">
